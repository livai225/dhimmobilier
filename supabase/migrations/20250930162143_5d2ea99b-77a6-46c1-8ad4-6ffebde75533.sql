-- Migration de Nettoyage Complet des Données Financières
-- Préserve les locations et souscriptions, supprime toutes les données de paiements
...
-- Étape 4: Supprimer toutes les échéances générées
DELETE FROM public.echeances_droit_terre;

-- Étape 5: Remettre à zéro le solde de caisse
