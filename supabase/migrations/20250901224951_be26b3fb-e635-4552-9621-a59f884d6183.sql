-- Update pay_caution_with_cash to standardize operation type
...
BEGIN
  ...
  -- Standardize type_operation to 'paiement_caution' for analytics consistency
  v_transaction_id := public.record_cash_transaction(
    ...
    p_description := COALESCE(p_description, 'Avance caution location') || ' - ' || v_location_record.propriete_nom,
