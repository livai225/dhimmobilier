        ...
        <Tabs defaultValue="informations" className="w-full">
          ...
          <TabsContent value="paiements" className="space-y-4">
            {loadingPayments ? (
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  <p className="text-muted-foreground">Aucun paiement trouvé pour ce client.</p>
                </CardContent>
              </Card>
            ) : (
                      ...
                      <div className="flex justify-between items-center">
                        <div className="space-y-1">
                          ...
                          <div className="text-sm text-muted-foreground">
                            <span>Date: {format(new Date(payment.date_paiement), "dd/MM/yyyy", { locale: fr })}</span>
                            {payment.mode_paiement && <span className="ml-4">Mode: {payment.mode_paiement}</span>}
                            {payment.reference && <span className="ml-4">Réf: {payment.reference}</span>}
                          </div>
                        </div>
